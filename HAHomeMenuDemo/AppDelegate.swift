...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let menuVC = mainStoryboard.instantiateViewController(withIdentifier: "NavMenu")
        let contentVC = mainStoryboard.instantiateViewController(withIdentifier: "NavDetail")
        ...
        // add VC menu
        contentVC.sideMenuViewController?.showMenu()
